#  Kitchen Sink Studio
This is Sanity's documentation and installation directions for how to use it's Kitchen Sink Studio. 
...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/3tgj6ado/settings/api) and create a token with read rights.
